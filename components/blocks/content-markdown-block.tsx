...
export default function ContentMarkdownBlock({ content, isTextDark, align = 'center' }: Props) {
  if (!content) {
    return null;
  }
  ...
  return (
    <div className="mb:mb-13.5 my-5">
      <div
        ...
        className={cn(
          'text-neutral-white mb:text-[25px] mb:mb-20 mb-0 font-sans text-xl leading-140',
          isLeft ? 'mx-0 max-w-none' : 'mx-auto max-w-[840px]',
          '[&>p]:mb-4',
          isLeft ? '[&>p]:text-left' : '[&>p]:text-center',
          '[&>h1]:tracking-039 [&>h1]:mb:text-[39px] [&>h1]:mb:leading-110 [&>h1]:mb:mb-9 [&>h1]:mb-5 [&>h1]:font-sans [&>h1]:text-[23px] [&>h1]:leading-120 [&>h1]:font-semibold',
          isLeft ? '[&>h1]:text-left' : '[&>h1]:text-center',
          '[&>h2]:tracking-039 [&>h2]:mb:text-[32px] [&>h2]:mb:leading-110 [&>h2]:mb:mb-7 [&>h2]:mb-4 [&>h2]:font-sans [&>h2]:text-[20px] [&>h2]:leading-120 [&>h2]:font-semibold',
          isLeft ? '[&>h2]:text-left' : '[&>h2]:text-center',
