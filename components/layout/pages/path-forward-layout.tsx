  'M46.4618 43.0836C52.9988 37.093 62.8945 35.7399 70.9699 40.4181C80.9517 46.2005 84.3717 59.0073 78.6087 69.0228C72.8457 79.0384 60.0821 82.4699 50.1004 76.6875C42.1783 72.0982 38.3899 63.0846 40.0445 54.5532L45.6183 55.9888C44.5802 62.0735 47.3303 68.4333 52.9699 71.7004C60.2067 75.8927 69.4603 73.4048 73.6385 66.1436C77.8166 58.8823 75.3371 49.5974 68.1004 45.4051C62.3069 42.0489 55.2213 42.9746 50.4815 47.2027L46.4618 43.0836Z',
  'M72.1983 52.77C74.5946 57.6582 73.7663 63.7349 69.7135 67.8014C64.6197 72.9124 56.361 72.9124 51.2672 67.8014C46.1734 62.6904 46.1734 54.4038 51.2672 49.2928C55.1941 45.3526 61.0017 44.4506 65.7904 46.5855L62.95 51.6443C60.3748 50.7225 57.3872 51.2959 55.3254 53.3647C52.4729 56.2268 52.4729 60.8673 55.3254 63.7295C58.1779 66.5917 62.8028 66.5917 65.6553 63.7295C67.8444 61.533 68.3538 58.2889 67.1829 55.6052L72.1983 52.77Z',
] as const;

const OUTER_RING_OVERLAY_PATH =
  'M43.1551 1.92705e-10C18.218 7.30494 2.38567e-06 30.4159 0 57.7971C-2.89694e-06 91.0462 26.8629 118 60 118C93.1371 118 120 91.0462 120 57.7971C120 30.5928 102.017 7.60331 77.3275 0.143149L75.7826 5.69208C98.0523 12.4744 114.261 33.2363 114.261 57.7971C114.261 87.8659 89.9675 112.241 60 112.241C30.0325 112.241 5.73912 87.8659 5.73913 57.7971C5.73913 33.0594 22.182 12.1758 44.6994 5.54791L43.1551 1.92705e-10Z';
...
function ScrollingZoneVector({
  ...
  const r0 = useTransform(scrollYProgress, [0.0, 0.09], [1, 0]);
  const r1 = useTransform(scrollYProgress, [0.09, 0.18], [1, 0]);
  const r2 = useTransform(scrollYProgress, [0.18, 0.27], [1, 0]);
  const r3 = useTransform(scrollYProgress, [0.27, 0.36], [1, 0]);
  const r4 = useTransform(scrollYProgress, [0.36, 0.45], [1, 0]);
      ...
      >
        ...
        >
          <defs>
            ...
            >
              <stop stopColor="#68EEEA" />
              <stop offset="1" stopColor="#00919B" />
            </linearGradient>
            <linearGradient
              id="sphere-purple"
              x1="120"
          ...
          {RING_PATHS_OUTSIDE_IN.map((d, i) => (
            <path key={`bg-${i}`} d={d} fill="url(#sphere-purple)" />
          ))}
          ...
          {RING_PATHS_OUTSIDE_IN.map((d, i) => (
            <motion.path
              key={`fg-${i}`}
              d={d}
              fill="url(#sphere-teal)"
              style={{ opacity: ringOpacities[i] }}
            />
          ))}

          <path d={OUTER_RING_OVERLAY_PATH} fill="url(#sphere-purple)" />
        </svg>
      </motion.div>
    </div>
  );
