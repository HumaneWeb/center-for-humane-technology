              ...
              <Link href={facebookUrl} target="_blank">
                ...
                >
                  <circle
                    ...
                    fill="#293462"
                    stroke="white"
                    className="group-hover:fill-neutral-white group-hover:duration-300"
                  />
                  <path
                    ...
                    fill="white"
                    className="group-hover:fill-primary-blue group-hover:duration-300"
                  />
                </svg>
              </Link>
            )}
                ...
                {column.links.map((link) => (
                  <li key={link.id} className="mb-4">
                    <CustomLink
                      // @ts-expect-error
                      content={link}
                      extraClass="text-neutral-white font-sans text-lg leading-135 font-normal transition-all duration-300 hover:underline"
                    >
                      {link.internalTitle}
                    </CustomLink>
                  </li>
