  ...
  return (
    <div className="flex flex-col gap-5">
      {networks.facebookUrl && (
        ...
        >
          <FacebookIcon />
          <span className="text-primary-teal mb:text-xl group-hover:text-primary-navy font-sans text-[18px] leading-120 font-medium underline group-hover:duration-200">
...
const FacebookIcon = () => (
  ...
  >
    <circle
      ...
      fill="#293462"
      stroke="white"
      className="group-hover:fill-primary-navy group-hover:duration-200"
    />
    <path
