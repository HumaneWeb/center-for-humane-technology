...
export default async function PodcastDetailPage({ params }: PageSlug) {
  ...
  return (
    <section>
      <div className="bg-gradient-podcast-list min-h-[700px]">
        <div className="mx-auto max-w-7xl px-4 pt-16 sm:px-6 lg:px-8">
          <CustomLink extraClass="flex items-center gap-2 mb-14">
            <svg
          ...
          <div className="grid grid-cols-[1.5fr_2fr] gap-10">
            <div>
              <CustomImage {...podcast?.image} extraClass="mb-10" />
            ...
            <div>
              ...
              <div className="mb-7 flex items-center gap-7">
                <Cta extraClass="flex items-center gap-2.5">
                  ...
                  >
                    <path
                      d="M19.5 11.134C20.1667 11.5189 20.1667 12.4811 19.5 12.866L9 18.9282C8.33333 19.3131 7.5 18.832 7.5 18.0622L7.5 5.93782C7.5 5.16802 8.33333 4.6869 9 5.0718L19.5 11.134Z"
                      fill="#0B1023"
                    />
                  </svg>
                ...
                <Cta extraClass="flex items-center gap-2.5 p-0 bg-transparent text-primary-blue underline">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
                    height="32"
              ...
              {podcast?.introduction && (
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: podcast?.introduction }}
                />
              )}
            </div>
          </div>
